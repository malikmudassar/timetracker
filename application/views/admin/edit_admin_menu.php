                ...
                <div class="login-form">
                    <form data-toggle="validator" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" class="form-control" type="text" name="class" value="<?php echo $menu_item['class']?>">
                        </div>
                        <div class="form-group">
                            <label for="username" class="control-label">Url</label>
                            <input id="username" class="form-control" type="text" name="url" value="<?php echo $menu_item['url']?>">
                        </div>
                        <div class="form-group">
